...
function preload() { // Preload function to ensure resources avaliable for setup and draw
  ...
  synthTrack = loadSound("https://cassinihxuwe.github.io/GWDS-FinalProject/JS/p5.js/project/assets/darkdancer.mp3"); //loading the sound from my assets directory
  myFont = loadFont("https://cassinihxuwe.github.io/GWDS-FinalProject/JS/p5.js/project/assets/Streamster.otf"); //loading the font from my assets directory
} // closing my preload
